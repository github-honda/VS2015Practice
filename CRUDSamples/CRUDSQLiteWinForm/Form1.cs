...
namespace CRUDSQLiteWinForm
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            Text = "WinForm CRUD Template for SQLite, v " + Application.ProductVersion;
        ...
        private void DataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            long lFID = (long)row1.Cells["FID"].Value;
            txtFID.Text = lFID.ToString();
            EntryRead(lFID);
        }
        void myClearQuery()
        {
        ...
        DataTable DBReadTable_Parents(int iParentID = -1)
        {
            ...
            try
            {
                ...
                {
                    DataSet ds1 = null;
                    SQLiteCommand command = cn1.CreateCommand();
                    if (iParentID < 0)
        ...
        void myLoadKeyList()
        {
            ...
            {
                string s1 = row1["FKey"].ZToString() + ":" + row1["FValue"].ZToString() + ":" + row1["FID"].ZToLong().ZToString();
        ...
        void EntryUpdate()
        {
            ...
            long FParentID_DB = row1["FParentID"].ZToLong();
