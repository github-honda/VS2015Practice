...
namespace CRUDSQLServerWinForm
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            Text = "WinForm CRUD Template for SQL Server, v " + Application.ProductVersion;
        ...
        DataTable DBReadTable_Parents(int iParentID = -1)
        {
            ...
            try
            {
                ...
                {
                    DataSet ds1 = null;
                    SqlCommand command = cn1.CreateCommand();
                    if (iParentID < 0)
        ...
        Boolean DBExistParentID(int iParentID)
        {
            if (iParentID < 0)
                return false;

            DataTable t1 = DBReadTable_Parents(iParentID);
            if (t1 == null)
                return false;
            if (t1.Rows.Count < 1)
                return false;
